...
the project's architectural rules defined in CITADEL.md.
...
1. Read CITADEL.md to understand the project's architecture rules
2. Read any files in `.citadel/rules/` for additional constraints
...
- You ALWAYS read CITADEL.md first.
