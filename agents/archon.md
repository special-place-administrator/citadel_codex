...
1. Check for active campaign in `.citadel/campaigns/` (not `completed/`)
2. If `.citadel/coordination/` exists: check for scope claims before selecting work
...
Create campaigns at `.citadel/campaigns/{slug}.md`:
...
- Project's CITADEL.md (conventions, architecture)
- Agent context from `.citadel/agent-context/rules-summary.md`
...
1. Check `.citadel/intake/` for pending items
...
2. CITADEL.md (project conventions)
