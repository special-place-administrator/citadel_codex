...
1. Read CITADEL.md (project conventions)
2. Check `.citadel/campaigns/` for active campaigns
3. Check `.citadel/coordination/claims/` for external claims
...
Wave 1: Log wave-start → 2-3 independent agents (worktree-isolated)
  ...
  ← Write discovery briefs to .citadel/fleet/briefs/
...
5. Write compressed briefs (~500 tokens each) to `.citadel/fleet/briefs/`
...
Create at `.citadel/fleet/session-{slug}.md`:
...
- Check `.citadel/coordination/claims/` before assigning work
