...
1. Read project documentation to understand the project's architecture and conventions
...
1. Load the relevant skill if one exists (e.g., the review skill for audit steps)
...
- Suggest creating a skill if a pattern will recur: "This pattern would
  make a good skill. Invoke the skill-creator skill to capture it."
