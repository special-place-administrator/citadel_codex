...
**Setup integration:** During project setup, if the project is a web app (has
...
- When the router matches: "qa", "test the app", "does it work", "click through it"
- When campaigns reach the verification phase
