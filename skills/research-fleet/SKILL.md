...
research-fleet is the research skill scaled to parallel execution. Instead of one agent
...
## When to Use Over research skill
...
If the question is narrow and focused, use the research skill instead. Don't
parallelize what a single agent can answer in 5 minutes.
...
3. Each scout follows the research skill protocol (formulate, search, extract, write)
4. Each scout writes its findings to `.citadel/research/fleet-{slug}/{angle-slug}.md`
...
- Each scout follows research skill quality gates (sources, confidence, evidence)
