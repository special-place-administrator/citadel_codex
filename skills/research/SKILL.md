...
Research skill for focused investigations. It converts questions into structured
...
Write findings to `.citadel/research/{topic-slug}.md`:
...
Return the summary and recommendation to the caller.
...
- Document: .citadel/research/{slug}.md
---
```
