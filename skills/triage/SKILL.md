...
5. **Check cross-platform.** Does it assume Unix? Does it handle Windows paths and line endings correctly?
...
- Skills system — skill discovery, harness, runtime
- `skills/` — individual skill files
- Agents — agent system and configs
- `.citadel/` — project state and planning system
- `docs/` — documentation
- Root files — project setup (README, package.json)
...
- **Environment** — OS, shell, Node version, tool version
